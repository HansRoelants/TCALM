...
try
{
  .\Pull-CrmSolution.ps1 `
    -serverUrl "https://tcalm.crm4.dynamics.com" `
    -username (Get-CrmUsername "Crm.ThomasCook") `
    -password (Get-CrmPassword "Crm.ThomasCook") `
    -solutionName "ThomasCookBase" `
    -solutionRootFolder "..\..\Crm.ThomasCook" `
    -solutionMapFile "..\..\Nullfactory.Xrm.Tooling\Mappings\ThomasCook-mapping.xml"
